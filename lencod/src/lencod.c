...
clock_t time_to_encode_intra_mode;

const char* file_name = "C:\\Users\\Truong\\Desktop\\python_project\\th_da_phuong_tien\\test_video_2_result.txt";
FILE* file = NULL;
...
int main(int argc, char **argv)
{
  ...
  printf("Time to encode %lf\n", (double)(time_to_encode_intra_mode) / (double)(p_Enc->p_Vid->p_Stats->frame_counter));
