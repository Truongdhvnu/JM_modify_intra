...
// this is our added parameter
#define INTRA4x4_EXIT_SOON 0
#define PRINT_MODE_SELECT_INTRA 0
#if defined _DEBUG
...
enum {
  ...
  VERT_LEFT_PRED       = 7,
  HOR_UP_PRED          = 8,
  MODE_ADD_VER_RIGHT         = 9,
  MODE_ADD_VER_LEFT       = 10,
  MODE_ADD_HOR_RIGHT       = 11,
  MODE_ADD_HOR_LEFT    = 12,
} I4x4PredModes;
